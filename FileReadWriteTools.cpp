...
void FileReadWriteTools::extractFileCommandsAndResources(const std::string& filePath, std::map<std::string, std::string>& fileCommandsAndResources)
{
...
void FileReadWriteTools::extractFileCommandsAndResources(const std::string & filePath, std::map<std::string, std::string>& fileCommandsAndResources, int levelNum)
{
	std::ifstream infoReader = getReader(filePath);
...
void FileReadWriteTools::extractSoundsFileNames(	const std::string& filePath,
